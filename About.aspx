<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="POC_Contact1.About" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <form action="/fr/nous-ecrire/14/Contact" class="form-horizontal" method="post" novalidate="novalidate"><input id="FormType" name="FormType" type="hidden" value=""><input id="MailViewName" name="MailViewName" type="hidden" value=""> 
        <style>
...
.chrome .docapost-input-file {
    padding: 6px 0 !important;
        ...
        <div class="alert alert-danger summary-form hidden" data-valmsg="Un ou plusieurs champs obligatoires n'ont pas été remplis correctement. Merci de vérifier votre saisie :" role="alert"></div>
    <fieldset class="form-group">
        <legend class="control-label col-md-3"><span>*</span>Civilité</legend>
        <ul class="list-inline no-margin-bottom col-md-5">
            <li>
                <label class="radio-inline" for="Mr">
                    <input aria-describedby="error-Gender" data-val="true" data-val-required="Champ obligatoire" id="Mr" name="Gender" type="radio" value="Mr">
                    M.
                </label>
            </li>
            <li>
                <label class="radio-inline" for="Mme">
                    <input aria-describedby="error-Gender" id="Mme" name="Gender" type="radio" value="Mme">
                    Mme
                </label>
            </li>
        </ul>
        <div class="col-md-offset-3 col-md-5"><span class="field-validation-valid text-error" data-valmsg-for="Gender" data-valmsg-replace="true" id="error-Gender"></span></div>
    </fieldset>
    <div class="form-group required">
        <label class="col-md-3 control-label cw-asterisk" for="FirstName">Prénom</label>
        <div class="col-md-5">
            <input aria-describedby="error-FirstName" autofocus="autofocus" class="form-control" data-val="true" data-val-required="Champ obligatoire" id="FirstName" name="FirstName" type="text" value="">
    ...
    <div class="form-group required">
        ...
        <div class="col-md-5">
            <input aria-describedby="error-LastName" class="form-control" data-val="true" data-val-length="Le champ Nom doit être une chaîne dont la longueur maximale est de 50." data-val-length-max="50" data-val-required="Champ obligatoire" id="LastName" name="LastName" type="text" value="">
    ...
    <div class="form-group required">
        ...
        <div class="col-md-5">
            <textarea aria-describedby="error-Address" class="form-control" cols="20" id="Address" name="Address" rows="2"></textarea>
            <span class="field-validation-valid text-error" data-valmsg-for="Address" data-valmsg-replace="true" id="error-Address"></span>
        </div>
    </div>
    <div class="form-group required">
        <label class="col-md-3 control-label" for="PostalCode">Code postal</label>
        <div class="col-md-5">
            <input aria-describedby="error-PostalCode" class="form-control" data-val="true" data-val-length="Le champ Code postal doit être une chaîne dont la longueur maximale est de 5." data-val-length-max="5" id="PostalCode" name="PostalCode" type="text" value="">
            <span class="field-validation-valid text-error" data-valmsg-for="PostalCode" data-valmsg-replace="true" id="error-PostalCode"></span>
        </div>
    </div>
    <div class="form-group required">
        <label class="col-md-3 control-label" for="Locality">Ville</label>
        <div class="col-md-5">
            <input aria-describedby="error-Locality" class="form-control" id="Locality" name="Locality" type="text" value="">
            <span class="field-validation-valid text-error" data-valmsg-for="Locality" data-valmsg-replace="true" id="error-Locality"></span>
        </div>
    </div>
    <div class="form-group required">
        <label class="col-md-3 control-label cw-asterisk" for="Email">Email</label>
        <div class="col-md-5">
            <input aria-describedby="error-Email" class="form-control" data-val="true" data-val-email="Le format de l'adresse email est incorrect" data-val-required="Champ obligatoire" id="Email" name="Email" type="text" value="">
    ...
    <div class="form-group required">
        ...
        <div class="col-md-5">
            <input aria-describedby="error-PhoneNumber" class="form-control" id="PhoneNumber" name="PhoneNumber" type="text" value="">
    ...
    <div class="form-group required">
        <label class="col-md-3 control-label" for="Mobile">Téléphone mobile</label>
        <div class="col-md-5">
            <input aria-describedby="error-Mobile" class="form-control" id="Mobile" name="Mobile" type="text" value="">
            <span class="field-validation-valid text-error" data-valmsg-for="Mobile" data-valmsg-replace="true" id="error-Mobile"></span>
        </div>
    </div>
    <div class="form-group required">
        <label class="col-md-3 control-label cw-asterisk" for="Object">Objet du message</label>
        <div class="col-md-5">
            <select aria-describedby="error-Object" class="form-control" data-val="true" data-val-number="Le champ Objet du message doit être un nombre." data-val-required="Champ obligatoire" id="Object" name="Object" onchange="cityWay.forms.onChangeObject('Object', '1', 'object-complaint');"><option value="">-- Choisir un objet --</option>
<option value="1">Faire une réclamation</option>
<option value="2">Demande de renseignements</option>
<option value="7">Autre</option>
</select>
            <span class="field-validation-valid text-error" data-valmsg-for="Object" data-valmsg-replace="true" id="error-Object"></span>
        </div>
    </div>
    <div id="object-complaint" class="hidden">
        <div class="form-group required">
            <label class="col-md-3 control-label" for="DateComplaint">Date de l'incident</label>
            <div class="col-md-5">
                <input aria-describedby="sample-DateComplaint error-DateComplaint" class="form-control" data-val="true" data-val-regex="La date saisie n'est pas valide" data-val-regex-pattern="^(0?\d|[12]\d|3[01])/(0?\d|1[012])/((?:19|20)\d{2})$" id="DateComplaint" name="DateComplaint" type="text" value="">
                <span class="field-validation-valid text-error" data-valmsg-for="DateComplaint" data-valmsg-replace="true" id="error-DateComplaint"></span>
                <p class="help-block" id="sample-DateComplaint">(exemple : 29/03/2012)</p>
            </div>
        </div>

        <div class="form-group required">
            <label class="col-md-3 control-label" for="HourComplaint">Heure</label>
            <div class="col-md-5">
                <input aria-describedby="sample-HourComplaint error-HourComplaint" class="form-control" data-val="true" data-val-regex="L'heure saisie n'est pas valide" data-val-regex-pattern="^[0-9]{2}h[0-9]{2}$" id="HourComplaint" name="HourComplaint" type="text" value="">
                <span class="field-validation-valid text-error" data-valmsg-for="HourComplaint" data-valmsg-replace="true" id="error-HourComplaint"></span>
                <p class="help-block" id="sample-HourComplaint">(exemple : 11h38)</p>
            </div>
        </div>

        <div class="form-group required">
            <label class="col-md-3 control-label" for="Line">Ligne</label>
            <div class="col-md-5">
                <input aria-describedby="error-Line" class="form-control" id="Line" name="Line" type="text" value="">
                <span class="field-validation-valid text-error" data-valmsg-for="Line" data-valmsg-replace="true" id="error-Line"></span>
            </div>
        </div>

        <div class="form-group required">
            <label class="col-md-3 control-label" for="Stop">Nom de l'arrêt</label>
            <div class="col-md-5">
                <input aria-describedby="error-Stop" class="form-control" id="Stop" name="Stop" type="text" value="">
                <span class="field-validation-valid text-error" data-valmsg-for="Stop" data-valmsg-replace="true" id="error-Stop"></span>
            </div>
        </div>
        ...
        <div class="form-group required">
            ...
            <div class="col-md-5">
                <input aria-describedby="error-Destination" class="form-control" id="Destination" name="Destination" type="text" value="">
                <span class="field-validation-valid text-error" data-valmsg-for="Destination" data-valmsg-replace="true" id="error-Destination"></span>
            </div>
        </div>

    </div>
    <div class="form-group required">
        <label class="col-md-3 control-label cw-asterisk" for="Message">Message</label>
        <div class="col-md-5">
            <textarea aria-describedby="error-Message" class="form-control" cols="20" data-val="true" data-val-required="Champ obligatoire" id="Message" name="Message" rows="2"></textarea>
            <span class="field-validation-valid text-error" data-valmsg-for="Message" data-valmsg-replace="true" id="error-Message"></span>
        </div>
    </div>
    <div class="form-group">
        <div class="checkbox col-md-5 col-md-offset-3">
            <label>
                <input data-val="true" data-val-required="Le champ En cochant cette case j'accepte de recevoir des informations commerciales de la part de {0} est requis." id="AcceptNewsletter" name="AcceptNewsletter" type="checkbox" value="true"><input name="AcceptNewsletter" type="hidden" value="false">
